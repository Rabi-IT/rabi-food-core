...
**Regra:** se a tarefa envolve código Go, invoque `/api-dev` antes de escrever. Se envolve código web, invoque `/web-dev` antes de escrever. Os agentes conhecem todos os padrões obrigatórios de cada subprojeto e vão guiar a implementação correta.
